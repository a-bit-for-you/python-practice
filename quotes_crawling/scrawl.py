...
project_path = r'F:\kanalytics-work\scripts'

# MongoDb Connection
# DB_username = urllib.parse.quote_plus('dbadmin')
# DB_password = urllib.parse.quote_plus('kailasaoct2019')
# mongo_client = pymongo.MongoClient("mongodb://"+DB_username+":"+DB_password+"@192.168.1.193:27017/")
